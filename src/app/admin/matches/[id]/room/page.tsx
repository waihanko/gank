    ...
    <div className="page-container">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <h1 className="font-display" style={{ fontSize: 24, fontWeight: 900 }}>Battle Group Record</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 32, alignItems: 'stretch' }}>
        {/* Chat History */}
        <div className="glass-card" style={{ padding: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '24px', display: 'flex', flexDirection: 'column', gap: 16, maxHeight: 'calc(100vh - 250px)' }}>
            {messages.length === 0 ? (
